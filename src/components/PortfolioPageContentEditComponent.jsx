...
import PortfolioDialogPop from "../childComponents/PortfolioDialogPop";

const PortfolioPageContentEditComponent = () => {
  return (
    <section>
      ...
      <div className="m-[30px] rounded-xl bg-[#36404A] p-[30px]">
        <h2 className="text-xl font-medium text-white">
          Portfolio Item Add/Remove Section
        </h2>
        <div className="mt-[16px]">
          <div>
              ...
              <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
                ...
                <tbody className="divide-y divide-gray-100 border-t border-gray-100">
                  <tr className="hover:bg-gray-50">
                    ...
                    <th className="  px-6 py-4 font-normal text-gray-900">
                      <div className="relative ">
                        <p>A Vibrant And Colorful Mobile Application</p>
                      </div>
                    </th>
