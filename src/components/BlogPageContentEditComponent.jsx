...
import BlogDialogPop from "../childComponents/BlogDialogPop";

const BlogPageContentEditComponent = () => {
  return (
    <section>
      <div className="m-[30px] rounded-xl bg-[#36404A] p-[30px]">
        <h2 className="text-xl font-medium text-white">Blog Info Edit</h2>
        <div className="mt-[16px]">
          <div className="grid gap-5">
            <div className="grid gap-2">
              <label className="text-base">Blog Info Edit</label>
                  ...
                  <tr className="hover:bg-gray-50">
                    <th className="  px-6 py-4 font-normal text-gray-900">
                      <div className="relative ">
                        <p>All that You Believe Should Realize About Making</p>
                      </div>
                    </th>
                    <th className="  px-6 py-4 font-normal text-gray-900">
                      <div className="relative ">
...
export default BlogPageContentEditComponent;
